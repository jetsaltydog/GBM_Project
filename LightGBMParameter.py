...
# Create the model
model = LGBMRegressor(colsample_bytree=0.5823970728930876,
                      boosting_type='dart',
                      max_depth=11,
                      min_child_samples=96,
                      min_split_gain=0.0800662421540158,
                      num_leaves=32,
                      subsample=0.7736268103434826)

colsample_bytree=0.8411367740809124,
max_depth=15,
min_child_samples63,
min_split_gain=0.06616105626244219,
num_leaves=138,
subsample=0.775858544114288
